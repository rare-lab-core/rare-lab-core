<!--
  GitHub Profile README for github.com/rare-lab-core
  Every activity card (streak, calendar, snake, activity graph, trophies) is
  regenerated daily by .github/workflows/profile-cards.yml and served as a
  static SVG from the output branch, so nothing here can be rate-limited.
-->
